...
class CheckoutSystem {
    ...
    // Formatear precios correctamente para Argentina
    formatPrice(value) {
    ...
    async processPayment() {
        ...
        // CLONAR ITEMS para evitar modificaciones
    ...
    showConfirmation(orderId) {
        ...
        document.getElementById('paymentMethod').textContent =
            this.getPaymentMethodName(this.orderData.paymentMethod);

        document.getElementById('deliveryMethod').textContent =
            this.orderData.deliveryMethod;

        document.getElementById('confirmationMessage').textContent =
            `Hemos enviado los detalles a ${this.customerData.email}`;
    }
