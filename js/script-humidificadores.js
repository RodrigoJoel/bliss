...
const SECTION_KEY = 'products_humidificadores';
let cachedProducts = [];
...
document.addEventListener('click', e => {
    ...
    cart.addProduct({ id: product.id, name: product.nombre, price: product.precio, section: 3, image: product.imagen, stock: product.stock }, 1);
    updateCartCount();
